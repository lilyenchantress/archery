...
public class bowAndArrow : MonoBehaviour {
	...
	void resetGame() {
		arrows = 10;
		score = 0;
		// be sure that there is only one arrow in athe game
	...
	//continue game after say dialog
